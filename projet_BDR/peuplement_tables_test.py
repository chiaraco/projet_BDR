...
for n in range(len(accident)):
	try:
		...
		depart=Aeroport.objects.get(OACI=accident.iloc[n][15])
		arrivee=Aeroport.objects.get(OACI=accident.iloc[n][16])
	
	except ObjectDoesNotExist as err:
		print('modele_avion',accident.iloc[n][8])
		...
		try:depart=Aeroport.objects.get(IATA=accident.iloc[n][17])
			...
			except MultipleObjectsReturned :print("nomaero_depart")
		except MultipleObjectsReturned :print("IATA_depart")
		...
		try:arrivee=Aeroport.objects.get(IATA=accident.iloc[n][18])
			...
			except MultipleObjectsReturned :print("nomaero_arrivee")
		except MultipleObjectsReturned :print("IATA_arrivee")
