...
vi_nan = Ville(nom_ville='Unknown', nom_pays=Pays.objects.get(nom_pays='Unknown'))
vi_nan.save()

ae = Aeroport(nom_aeroport='Unknown',ville=vi_nan)#latitude=None, longitude=None, altitude=None,iata='', oaci='',
ae.save() 
